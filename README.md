...
| oracle | Deterministic refusal / compliance / degenerate classifier | **validated at 5 of 6 corners** — [`docs/e5-oracle-validation.md`](docs/e5-oracle-validation.md); not yet checked against human labels |
